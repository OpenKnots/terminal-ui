...
import { TreeVisibleDemo } from './tree-visible-demo'
...
export default function PlaygroundPage() {
  return (
    <main className="flex flex-col gap-8 p-6 min-h-screen">
      ...
      <section className="flex flex-col gap-2">
        <h2 className="text-lg font-semibold font-mono text-[var(--term-fg)]">
          TerminalTree — Visible-Only Rendering
        </h2>
        <p className="text-sm text-[var(--term-fg-dim)] font-mono">
          Collapsed branches are not mounted in the DOM. Only visible nodes render.
        </p>
        <TreeVisibleDemo />
      </section>
